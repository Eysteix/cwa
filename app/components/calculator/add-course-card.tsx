  ...
  return (
    <div style={{ background: 'var(--surface)', borderRadius: 'var(--r)', boxShadow: 'var(--sh-md)', padding: 20, marginBottom: 16 }}>
      ...
      <div style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--ink-2)', marginBottom: 14, lineHeight: 1.5 }}>
        Add each course you're taking this semester. Your projected CWA updates instantly.
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 12 }}>
        ...
        <div>
          ...
          <p style={hintStyle}>{isGpa ? 'Grade point for this course (A=4.0, B=3.0, etc.).' : 'Your current or expected score out of 100.'}</p>
        </div>
      </div>
